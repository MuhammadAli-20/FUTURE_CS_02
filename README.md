...
This repository presents a phishing email analysis and cybersecurity awareness project completed during the Cyber Security Internship at Future Interns. The project investigates several phishing email scenarios designed to imitate trusted organisations and manipulate users into revealing sensitive information, updating payment details, downloading malicious files, or performing fraudulent financial actions.

The report includes detailed analysis of phishing techniques such as spoofed sender domains, suspicious hyperlinks, urgency-based language, fake security notifications, credential harvesting attempts, and social engineering tactics. Multiple email samples were examined using tools including MXToolbox and Google Admin Toolbox to analyse email headers, routing behaviour, and suspicious sender infrastructure.

Additionally, the project highlights phishing risk classifications, attack mechanisms, possible security impacts, and practical prevention strategies intended to improve cybersecurity awareness and reduce the likelihood of phishing-related attacks against individuals and organisations.
...
| Tool | Purpose |
|------|---------|
| MXToolbox | Performing email header analysis and identifying suspicious sender infrastructure |
| Google Admin Toolbox Messageheader | Inspecting email routing paths and analysing suspicious header information |
| Browser Developer Tools | Safely examining suspicious links and webpage elements |
